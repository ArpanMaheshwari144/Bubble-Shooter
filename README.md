...
- With the files open in Visual Studio Code, then open bubble-shooter.html and right click and then click on **Open With Live Server** or press the **Go Live** button at the bottom of the window to launch the files with [Live Server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer).
